...
description: Use when the user says "WB_OPEN", "WORKSPACE_BROWSER", "OPEN_WORKSPACE_BROWSER", or asks to open an internal file browser, built-in file browser, right-side browser file view, project file window, workspace file window, "project file hub", "workspace file hub", "项目文件入口", "工作区文件", "当前项目文件", "当前文件夹", "内置文件浏览器", "右侧浏览器打开文件夹", "项目文件夹窗口", or wants a Finder-like local project file view inside Codex instead of opening macOS Finder.
---
...
2. For natural-language requests such as "项目文件入口", "工作区文件", "当前项目文件", or "当前文件夹", interpret the request as: register the current workspace as the active project in the workspace hub.
...
- Avoid ambiguous short phrases such as "file", "文件", "/文件", or "文件页" as primary triggers in active editing threads.
